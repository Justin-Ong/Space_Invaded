...
public class Tutorial : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        textArray[7] = "Use Left Click to build a turret and Right Click to choose what turret to build. The enemies can change their path based on where you place your turrets, make sure to check using the tracers.";
        textArray[8] = "You can use LeftAlt + Mouse Left button to rotate your viewport. The mouse wheel is used to zoom in and out.";
        ...
        textArray[11] = "The goal is to defend your base for a certain amount of waves. You can press Esc to pause the game or check the controls.";
